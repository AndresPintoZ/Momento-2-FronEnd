      ...
      <div className="w3-container w3-content" style={{maxWidth: '1200px', marginTop: '80px'}}>
        <div className="w3-row">
          ...
          <div className="w3-col m8">
            <div className="modern-card w3-white w3-margin-left">
              <div className="w3-container w3-padding-16 w3-indigo" style={{ background: '#6366f1' }}>
                <h4>
                  <img src="https://www.w3schools.com/w3images/avatar5.png" className="w3-circle" style={{width: '40px', verticalAlign: 'middle', marginRight: '10px'}} alt="Avatar" />
                  Jane Doe <span className="w3-opacity w3-medium"> · Activa ahora</span>
                </h4>
              </div>
              <div className="w3-container w3-padding-24" style={{height: '450px', overflowY: 'auto', background: '#f8fafc'}}>
                <div className="w3-padding w3-white w3-card-2 w3-margin-bottom" style={{maxWidth: '70%', float: 'left', borderRadius: '4px 16px 16px 16px'}}>
                  <p><strong>Jane Doe</strong> <span className="w3-opacity">10:28</span></p>
                  <p>¡Hola! ¿Cómo va el diseño?</p>
                </div>
                <div className="w3-padding w3-indigo w3-card-2 w3-margin-bottom" style={{maxWidth: '70%', float: 'right', borderRadius: '16px 4px 16px 16px'}}>
              ...
              <div className="w3-container w3-padding-16 w3-border-top">
                <div className="w3-row">
                  ...
                  <div className="w3-col" style={{width: '15%', textAlign: 'center', paddingLeft: '10px'}}>
                    <button className="w3-button w3-theme-d2 w3-round w3-block">
